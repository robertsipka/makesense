...
#        print("%r" % data[i:i+4])
    ...
    print(process_fft(data[52:]))

def process_fft(data):
    #freqs = [0.0, 15.625, 31.25, 46.875, 62.5, 78.125, 93.75, 109.375, 125.0, 140.625, 156.25, 171.875, 187.5, 203.125, 218.75, 234.375, 250.0, 265.625, 281.25, 296.875, 312.5, 328.125, 343.75, 359.375, 375.0, 390.625, 406.25, 421.875, 437.5, 453.125, 468.75, 484.375, 500.0, 515.625, 531.25, 546.875, 562.5, 578.125, 593.75, 609.375, 625.0, 640.625, 656.25, 671.875, 687.5, 703.125, 718.75, 734.375, 750.0, 765.625, 781.25, 796.875, 812.5, 828.125, 843.75, 859.375, 875.0, 890.625, 906.25, 921.875, 937.5, 953.125, 968.75, 984.375]
    ...
    ampls = []
    for i in range(0, len(data), 4):
        ampls.append(get_float(data[i:i+4]))
    return freqs, ampls
